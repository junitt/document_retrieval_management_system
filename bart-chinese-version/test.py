...
import torch
from utils import calc_rouge_l
from torch.utils.data import DataLoader
from tqdm import tqdm
from lcstsdataset import lcstsdataset
import os
device = 'cuda' if torch.cuda.is_available() else 'cpu'
tokenizer = BertTokenizer.from_pretrained("./bart-fine-tuned-chinese")
model = BartForConditionalGeneration.from_pretrained("./bart-fine-tuned-chinese").to(device)
max_length=300
data_dir='./data'
